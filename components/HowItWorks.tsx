  ...
  return (
    <section className="py-32 px-6 bg-slate-50" ref={ref}>
      <div className="max-w-5xl mx-auto">
        <h2 className="font-serif text-4xl md:text-5xl text-center text-slate-900 mb-20">
          Simple by design.
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {STEPS.map((step, idx) => (
            <div key={idx} className="relative p-8 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
              <div className="text-6xl font-serif text-gray-100 font-bold absolute top-4 right-6 group-hover:text-primary/10 transition-colors">
                {step.num}
              </div>
