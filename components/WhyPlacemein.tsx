...
const AboutSection: React.FC<AboutSectionProps> = ({ activePersonaId }) => {
  ...
  return (
    <section className="py-32 px-6 bg-white border-t border-gray-100 relative overflow-hidden">
      ...
      <div className="absolute -left-20 top-40 opacity-[0.03] pointer-events-none rotate-12 transition-opacity duration-1000">
          ...
          <div>
            ...
            <div className="flex gap-12">
              <ScrollReveal animation="fade-up" delay={0.2}>
                <div>
                  <div className="font-sans font-bold text-5xl text-slate-900 mb-2 tracking-tight">
