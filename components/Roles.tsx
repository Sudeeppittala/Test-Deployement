...
const Pill: React.FC<PillProps> = ({ children, onClick }) => (
  <button 
    onClick={onClick}
    className="inline-block bg-white border border-gray-200 text-slate-600 rounded-full px-5 py-2 text-sm font-medium hover:border-primary hover:text-primary hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 cursor-pointer active:scale-95 ease-out-expo"
  >
    {children}
  </button>
);
