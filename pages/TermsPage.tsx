        ...
        <div className="prose prose-lg prose-slate max-w-none text-gray-600">
          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <p>
                For paid training programs (e.g., the Opportunity Guarantee Program), fees are non-refundable once the batch commences, unless otherwise specified in the enrollment agreement. Corporate recruitment fees follow the service agreement signed individually with each partner.
              </p>
            </section>
